        ...
        <main className="pricing-page">
            <div className="page-hero">
                <div className="event-order-card">
                    ...
                    <div className="event-order-banner">
                        Event Order
                    </div>

                    <div className="event-order-body">

                        <section className="event-order-section">
                            <h3>Order Details</h3>

                            <div className="event-order-grid">
                                <div className="event-order-label">
                                    Event ID
                                </div>
                                <div className="event-order-value">
                                    {eventOrder.event_id}
                                </div>
                            ...
                            <div className="event-order-grid">
                                ...
                                <div className="event-order-value">
                                    ...
                                    >
                                        ...
                                        />
                                        <path
                                            d="M194.9 33.3H169.8V120.8H194.9V33.3Z"
                                            fill="#533AFD"
                                        />
                                        <path
                                            fillRule="evenodd"
                                ...
                                <div className="event-order-value event-order-amount">
                                    ${(eventOrderManager.getOrderCost(eventOrder) / 100).toFixed(2)}
                                </div>
                            </div>
                        </section>
                        ...
                        <div className="event-order-actions">
                            {!orderPaid ? (
                                <>
                                    <button
                                        onClick={() => onMakePayment(eventOrder)}
