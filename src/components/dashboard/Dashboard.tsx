...
export default function Dashboard() {
    ...
    async function handleImportFacebookEvent(facebookEventUrl: string) {
        ...
        //
        // try{
        //     const result = await api.post("/events/import/facebook", {
        //         facebookEventUrl
        //     });
        ...
        <div style={{ display: "flex", gap: "2px" }}>
            ...
            <div style={{ flex: 1 }}>
                <div style={{ paddingLeft: 40 }}>
                    ...
                    {showImportFacebookForm && userId && (
                        <Modal onClose={() => setShowImportFacebookForm(false)}>
                            <ImportFacebookEventForm onImport={handleImportFacebookEvent}
                                                     open={true}
                                                     onClose={() => setShowImportFacebookForm(false)}
                            />
                        </Modal>
                    )}
